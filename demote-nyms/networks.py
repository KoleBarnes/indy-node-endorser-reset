...
Network = namedtuple('Network', ['id', 'name', 'genesis_url', 'genesis_path', 'indy_scan_base_url', 'indy_scan_network_id'])
...
class Networks(object, metaclass=Singleton):
    ...
    def resolve(self, network_id: str = None, genesis_url: str = None, genesis_path: str = None):
        ...
        if network_id and network_id in self.ids:
            ...
            indy_scan_base_url = self.networks[network_id].get("indyScanBaseUrl")
            indy_scan_network_id = self.networks[network_id].get("indyScanNetworkId")
        ...
        network = Network(network_id, network_name, genesis_url, genesis_path, indy_scan_base_url, indy_scan_network_id)
        return network